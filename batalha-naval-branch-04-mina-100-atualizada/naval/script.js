...
document.getElementById('iniciar-jogo').addEventListener('click', () => {
  const nomeJogador1 = document.getElementById('nome-jogador1').value.trim();
  const nomeJogador2 = document.getElementById('nome-jogador2').value.trim();

  if (!nomeJogador1 || !nomeJogador2) {
    document.getElementById('mensagem').innerText = 'Por favor, preencha os nomes dos dois jogadores.';
    return;
  }

  // Atualizar os nomes dos jogadores
  document.getElementById('nome-jogador1-label').innerText = nomeJogador1;
  document.getElementById('nome-jogador2-label').innerText = nomeJogador2;

  // Ocultar tela inicial e mostrar tela do jogo
  document.getElementById('tela-inicial').style.display = 'none';
  document.getElementById('tela-jogo').style.display = 'block';

  // Mostrar os elementos do tabuleiro e informações do jogo
  document.getElementById('tabuleiro-jogador1').style.display = 'block';
  document.getElementById('tabuleiro-jogador2').style.display = 'block';
  document.getElementById('inventario-jogador1').style.display = 'block';
  document.getElementById('inventario-jogador2').style.display = 'block';
  document.getElementById('dinheiro-jogador1').style.display = 'block';
  document.getElementById('dinheiro-jogador2').style.display = 'block';
  document.getElementById('botao-turno').style.display = 'block';
});

function criarTabuleiro(tamanho, idTabuleiro) {
  const tabuleiro = document.getElementById(idTabuleiro);
  tabuleiro.style.gridTemplateColumns = `repeat(${tamanho}, 40px)`; // Define as colunas
  tabuleiro.innerHTML = ''; // Limpa o conteúdo anterior
...
document.getElementById('iniciar-jogo').addEventListener('click', () => {
  const tamanho = parseInt(document.getElementById('tamanho-mapa').value, 10);
  const nomeJogador1 = document.getElementById('nome-jogador1').value.trim();
  const nomeJogador2 = document.getElementById('nome-jogador2').value.trim();
  ...
  // Atualiza nomes e mostra elementos do jogo
  document.getElementById('nome-jogador1-label').innerText = nomeJogador1;
  document.getElementById('nome-jogador2-label').innerText = nomeJogador2;
  document.getElementById('tela-inicial').style.display = 'none';
  document.getElementById('tela-jogo').style.display = 'block';

  // Cria os tabuleiros dinamicamente
  criarTabuleiro(tamanho, 'tabuleiro-jogador1');
  criarTabuleiro(tamanho, 'tabuleiro-jogador2');
});
